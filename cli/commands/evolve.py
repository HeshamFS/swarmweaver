"""Evolve mode: Open-ended improvement of an existing project."""
...
def evolve(
    ...
    goal: str = typer.Option(..., "--goal", help="Improvement goal (e.g., 'Add unit tests for 80% coverage')"),
    ...
    """Open-ended improvement of an existing project."""
    task_input = get_task_input("evolve", goal=goal)
    run_agent(
