...
interface InvestigationReportBlockProps {
  isLoading: boolean;
...
export default function InvestigationReportBlock({
  isLoading,
  reportText,
  onAcknowledge,
  acknowledged,
}: InvestigationReportBlockProps) {
    ...
    return (
      <div className="border border-[#222] bg-[#121212] mb-3 font-mono">
        <div className="flex items-center gap-3 px-4 py-2">
          ...
          <span className="text-[#555] text-xs font-bold uppercase tracking-wider">Investigation Acknowledged</span>
  ...
  return (
    <div className="border border-[#333] bg-[#121212] mb-3 font-mono">
      ...
      <div className="flex items-center gap-3 px-4 py-2 border-b border-[#222] bg-[#0C0C0C]">
        ...
        <span className="text-[#E0E0E0] text-xs font-bold uppercase tracking-wider">Investigation Report</span>
        {isStreamingPartial && (
